export default function Footer() {
  return (
    <footer className="border-t border-slate-100 bg-white py-4 px-6 mt-auto">
      <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-slate-400">
        <p>
          Built by{' '}
          <span className="font-semibold text-slate-600">Koyal Mohadikar</span>
          {' '}—{' '}
          <span className="text-slate-500">AI-Powered Invoice &amp; Finance Manager</span>
        </p>
